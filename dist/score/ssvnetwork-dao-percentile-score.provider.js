...
exports.SSVNetworkPercentileScoreProvider = void 0;
const get_weights_1 = require("../util/get-weights");
const interfaces_1 = require("./interfaces");
class SSVNetworkPercentileScoreProvider extends interfaces_1.BaseProvider {
    constructor(resourceName) {
        super(resourceName);
        this.resourceName = resourceName;
    }
    async preload(resourceName) {
        this.weights = await (0, get_weights_1.getWeights)(resourceName || this.resourceName || "ssvnetwork");
    }
    getForumScore(stat) {
...
exports.SSVNetworkPercentileScoreProvider = SSVNetworkPercentileScoreProvider;
